          ...
          <div className="checkbox">
            ...
            <input
              ...
              onChange={() => {
                setConditions((prev) => ({
                  ...prev,
                  allow_pets: toggle(conditions.allow_pets),
                }));
              }}
            />
          </div>
          ...
          <div className="checkbox">
            ...
            <input
              ...
              onChange={() => {
                setConditions((prev) => ({
                  ...prev,
                  allow_oversize: toggle(conditions.allow_oversize),
                }));
              }}
            />
          </div>
          ...
          <div className="checkbox">
            ...
            <input
              ...
              onChange={() => {
                setConditions((prev) => ({
                  ...prev,
                  allow_skis: toggle(conditions.allow_skis),
                }));
              }}
            />
          </div>
          ...
          <div className="checkbox">
            ...
            <input
              ...
              onChange={() => {
                setConditions((prev) => ({
                  ...prev,
                  allow_bikes: toggle(conditions.allow_bikes),
                }));
              }}
            />
          </div>
